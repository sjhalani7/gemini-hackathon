...
const CourseSelectionPage = () => {
  ...
  return (
    <div className="course-selection-container flex flex-col items-center h-full w-full">
      <p className="selection-title mt-24 mb-2">Select a course</p>
      <p className="mb-2">Term: Fall 2024</p>
      <div className="input-container w-1/4 relative mb-2">
        <input
          type="text"
      ...
      <div className="course-list flex flex-col w-1/4 mb-24">
        {filteredCourses.map((course, index) => (
          <button key={index} className="course-item w-full p-2 mb-0.5">
            {course}
          </button>
        ))}
      </div>
